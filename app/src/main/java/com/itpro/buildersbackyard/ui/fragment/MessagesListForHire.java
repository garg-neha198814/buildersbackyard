...
public class MessagesListForHire extends Fragment implements AdapterView.OnItemClickListener, AppRequest {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        is_open = Boolean.TRUE;
        getActivity().registerReceiver(reciever, new IntentFilter("msg_hire"));
        inflateViews();
        ...
        try {
            ...
            if (responseBean.getStatus().equals("0") && responseBean.getBlockStatus() != null && responseBean.getBlockStatus().equals("1")) {
                ...
                if (messageList.size() == 0) {
                    ...
                    adapter = new MessagesAdapter(getActivity(), messageList, "hire", MessagesListForHire.this);
